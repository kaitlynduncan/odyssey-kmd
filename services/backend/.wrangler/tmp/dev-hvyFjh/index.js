...
// .wrangler/tmp/bundle-1nZy5r/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-1nZy5r/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-1nZy5r/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
menuRoutes.openapi(
  ...
  async (c2) => c2.json(await createMenuCategory(c2.get("db"), c2.req.valid("json")), 201)
);
